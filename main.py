...
class ProductOut(BaseModel):
    ...
    description: Optional[str] = None  # LLM 하위 단계에서 채울 예정
...
def recommend(req: RecommendRequest):
    ...
    # 🔸 여기서 "나중에" 지역 필터 적용
    #     유사도는 전체 로그 기준으로 계산하고,
    #     실제 추천에 쓰는 로그는 요청 region과 같은 것만 사용
    ...
    for item in avg_scores[:5]:
        ...
        p_out = ProductOut(
            ...
            description=None,   # RAG에서 채울 예정이면 나중에 사용
        )
